...
Upon utilising the Catboost classifier, we can observe from @fig-lgbconf that the classifier __has a marginally better accuracy when compared to the logistic regression, XGboost and Light GBM.__
...
preds <- predict(xgb_model,df_test,type='response')
